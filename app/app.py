...
st.markdown("---")
st.markdown(
    "<center><small>Developed with dedication ❤️✨ using Scikit-Learn & Streamlit· "
    "Titanic Dataset · "
    "<a href='https://github.com/aniket-chaudhary321/AI-ML-Titanic-Survival-Prediction.git' target='_blank'>GitHub</a>"
    "</small></center>",
    unsafe_allow_html=True,
)
